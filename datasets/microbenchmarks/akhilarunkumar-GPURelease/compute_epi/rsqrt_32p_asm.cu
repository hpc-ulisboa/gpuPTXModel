...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "rsqrt.approx.f32 %r113, %r113;\n\t" 
                    "rsqrt.approx.f32 %r114, %r114;\n\t" 
                    "rsqrt.approx.f32 %r115, %r115;\n\t" 
                    "rsqrt.approx.f32 %r116, %r116;\n\t" 
                    "rsqrt.approx.f32 %r117, %r117;\n\t" 
                    "rsqrt.approx.f32 %r118, %r118;\n\t" 
                    "rsqrt.approx.f32 %r119, %r119;\n\t" 
                    "rsqrt.approx.f32 %r120, %r120;\n\t" 
                    "rsqrt.approx.f32 %r121, %r121;\n\t" 
                    "rsqrt.approx.f32 %r122, %r122;\n\t" 
                    "rsqrt.approx.f32 %r123, %r123;\n\t" 
                    "rsqrt.approx.f32 %r124, %r124;\n\t" 
                    "rsqrt.approx.f32 %r125, %r125;\n\t" 
                    "rsqrt.approx.f32 %r126, %r126;\n\t" 
                    "rsqrt.approx.f32 %r127, %r127;\n\t" 
                    "rsqrt.approx.f32 %r128, %r128;\n\t" 
                    "rsqrt.approx.f32 %r113, %r113;\n\t" 
                    "rsqrt.approx.f32 %r114, %r114;\n\t" 
                    "rsqrt.approx.f32 %r115, %r115;\n\t" 
                    "rsqrt.approx.f32 %r116, %r116;\n\t" 
