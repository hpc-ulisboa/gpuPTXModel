...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "mul.lo.s32 %r113, %r111, %r113;\n\t"
                    "mul.lo.s32 %r114, %r111, %r114;\n\t"
                    "mul.lo.s32 %r115, %r111, %r115;\n\t"
                    "mul.lo.s32 %r116, %r111, %r116;\n\t"
                    "mul.lo.s32 %r117, %r111, %r117;\n\t"
                    "mul.lo.s32 %r118, %r111, %r118;\n\t"
                    "mul.lo.s32 %r119, %r111, %r119;\n\t"
                    "mul.lo.s32 %r120, %r111, %r120;\n\t"
                    "mul.lo.s32 %r121, %r111, %r121;\n\t"
                    "mul.lo.s32 %r122, %r111, %r122;\n\t"
                    "mul.lo.s32 %r123, %r111, %r123;\n\t"
                    "mul.lo.s32 %r124, %r111, %r124;\n\t"
                    "mul.lo.s32 %r125, %r111, %r125;\n\t"
                    "mul.lo.s32 %r126, %r111, %r126;\n\t"
                    "mul.lo.s32 %r127, %r111, %r127;\n\t"
                    "mul.lo.s32 %r128, %r111, %r128;\n\t"
                    "mul.lo.s32 %r113, %r111, %r113;\n\t"
                    "mul.lo.s32 %r114, %r111, %r114;\n\t"
                    "mul.lo.s32 %r115, %r111, %r115;\n\t"
                    "mul.lo.s32 %r116, %r111, %r116;\n\t"
