...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "fma.rn.f64 %r113, %r129, %r113, %r112;\n\t" 
                    "fma.rn.f64 %r114, %r129, %r114, %r112;\n\t" 
                    "fma.rn.f64 %r115, %r129, %r115, %r112;\n\t" 
                    "fma.rn.f64 %r116, %r129, %r116, %r112;\n\t" 
                    "fma.rn.f64 %r117, %r129, %r117, %r112;\n\t" 
                    "fma.rn.f64 %r118, %r129, %r118, %r112;\n\t" 
                    "fma.rn.f64 %r119, %r129, %r119, %r112;\n\t" 
                    "fma.rn.f64 %r120, %r129, %r120, %r112;\n\t" 
                    "fma.rn.f64 %r121, %r129, %r121, %r112;\n\t" 
                    "fma.rn.f64 %r122, %r129, %r122, %r112;\n\t" 
                    "fma.rn.f64 %r123, %r129, %r123, %r112;\n\t" 
                    "fma.rn.f64 %r124, %r129, %r124, %r112;\n\t" 
                    "fma.rn.f64 %r125, %r129, %r125, %r112;\n\t" 
                    "fma.rn.f64 %r126, %r129, %r126, %r112;\n\t" 
                    "fma.rn.f64 %r127, %r129, %r127, %r112;\n\t" 
                    "fma.rn.f64 %r128, %r129, %r128, %r112;\n\t" 
                    "fma.rn.f64 %r113, %r129, %r113, %r112;\n\t" 
                    "fma.rn.f64 %r114, %r129, %r114, %r112;\n\t" 
                    "fma.rn.f64 %r115, %r129, %r115, %r112;\n\t" 
                    "fma.rn.f64 %r116, %r129, %r116, %r112;\n\t" 
