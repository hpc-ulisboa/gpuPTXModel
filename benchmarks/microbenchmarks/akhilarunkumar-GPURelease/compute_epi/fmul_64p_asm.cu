...
void compute(float* D, int n, int div) {
    ...
    if (thread_id < div) {
        ...
        for (int k = 0; k < n; k++) {
            __asm volatile (
                    "mul.rn.f64 %r113, %r112, %r113;\n\t" 
                    "mul.rn.f64 %r114, %r112, %r114;\n\t" 
                    "mul.rn.f64 %r115, %r112, %r115;\n\t" 
                    "mul.rn.f64 %r116, %r112, %r116;\n\t" 
                    "mul.rn.f64 %r117, %r112, %r117;\n\t" 
                    "mul.rn.f64 %r118, %r112, %r118;\n\t" 
                    "mul.rn.f64 %r119, %r112, %r119;\n\t" 
                    "mul.rn.f64 %r120, %r112, %r120;\n\t" 
                    "mul.rn.f64 %r121, %r112, %r121;\n\t" 
                    "mul.rn.f64 %r122, %r112, %r122;\n\t" 
                    "mul.rn.f64 %r123, %r112, %r123;\n\t" 
                    "mul.rn.f64 %r124, %r112, %r124;\n\t" 
                    "mul.rn.f64 %r125, %r112, %r125;\n\t" 
                    "mul.rn.f64 %r126, %r112, %r126;\n\t" 
                    "mul.rn.f64 %r127, %r112, %r127;\n\t" 
                    "mul.rn.f64 %r128, %r112, %r128;\n\t" 
                    "mul.rn.f64 %r113, %r112, %r113;\n\t" 
                    "mul.rn.f64 %r114, %r112, %r114;\n\t" 
                    "mul.rn.f64 %r115, %r112, %r115;\n\t" 
                    "mul.rn.f64 %r116, %r112, %r116;\n\t" 
